...
const apiUrl = "https://movie-go-123.herokuapp.com";
...
document.querySelector(".authButton1").addEventListener("click",function(){
    location.href = "https://movie-go-123.herokuapp.com/auth/google";
});

document.querySelector(".authButton2").addEventListener("click",function(){
    location.href = "https://movie-go-123.herokuapp.com/auth/facebook";
});
