...
const apiUrl = "https://thawing-tundra-16872.herokuapp.com";
...
document.querySelector(".authButton1").addEventListener("click",function(){
    location.href = "https://thawing-tundra-16872.herokuapp.com/auth/google";
});

document.querySelector(".authButton2").addEventListener("click",function(){
    location.href = "https://thawing-tundra-16872.herokuapp.com/auth/facebook";
});
